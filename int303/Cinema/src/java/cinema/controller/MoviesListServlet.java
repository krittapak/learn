...
public class MoviesListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        MoviesListJpaController moviectrl= new MoviesListJpaController(pass, user);
        List<MoviesList> ml= moviectrl.findMoviesListEntities();
        request.setAttribute("MoviesList", ml);
        getServletContext().getRequestDispatcher("/MovieListView.jsp").forward(request, response);
