...
UserTransaction utx;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        AccountJpaController acc=new AccountJpaController(utx, emf);
        
        Account accountId=acc.findAccount(accountLogin.getAccountid());
        List<History> history=accountId.getHistoryList();
        
        request.setAttribute("history", accountLogin);
